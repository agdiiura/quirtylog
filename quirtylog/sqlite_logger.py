...
class SQLiteHandler(logging.Handler):
    ...
    Attributes:
    - log_table (str): The name of the table in the SQLite database.
    """

    log_table = 'log'

    _initial_sql = f"""CREATE TABLE IF NOT EXISTS {log_table}(
                        TimeStamp TEXT,
                        Source TEXT,
                        LogLevel INT,
                        LogLevelName TEXT,
    ...
    _insertion_sql = f"""INSERT INTO {log_table}(
                        TimeStamp,
                        Source,
                        LogLevel,
                        LogLevelName,
    ...
    def __init__(self, db: Path | str = 'log.db'):
        ...
        Parameters:
        - db: A path for creating the SQLite database (default: 'log.db').
    ...
    def format_time(record):
        ...
        Parameters:
        - record: The log record to which the time-stamp will be added.
